...
import type { InterviewConfig } from "@/context/InterviewContext";
  ...
  return (
    <div className="min-h-screen bg-background gradient-hero">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          {/* Hero Section */}
          <motion.section variants={itemVariants} className="text-center max-w-3xl">
            <motion.div
            ...
            {pastSessions > 0 && (
              <motion.div
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-muted px-4 py-2 text-sm text-muted-foreground"
              >
          ...
          <motion.div variants={itemVariants} className="w-full max-w-2xl">
            <AppCard className="p-6 sm:p-8" animate={false}>
              <div className="mb-6">
